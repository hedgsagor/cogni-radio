...
streams = [
    ...
    {"name": "I love Radio", "link": "https://streams.ilovemusic.de/iloveradio2.mp3"},
...
@bot.command()
async def help(ctx):
  imageURL = "https://i0.wp.com/novocenter.com.pe/wp-content/uploads/2021/05/ICFR-F10N-2.png?fit=1600%2C1200&ssl=1"
  embed=discord.Embed(title="Comando de ayuda", description="Hey soy una radio para Discord.", color=0x3194bf)
  embed.set_author(name="Help", url="https://github.com/", icon_url="https://i.imgur.com/w5XnsL3.png")
  embed.set_image(url=imageURL)
  embed.add_field(name="%rplay", value="Inicia la radio en un canal de voz", inline=False)
  embed.add_field(name="%rstop", value="Detener y desconectar la radio del canal de voz", inline=False)
  embed.set_footer(text="Creador x-name15")
